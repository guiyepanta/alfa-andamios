...
this.btnList = {
    ...
    "forecolor":      ['ForeColor',            'Color Fuente',       'editor_action(this.id)',  'ed_color_fg.gif'],
    ...
    "createlink":     ['CreateLink',           'Insertar Link',      'editor_action(this.id)',  'ed_link.gif'],
    "inserttable":    ['InsertTable',          'Insertar Tabla',     'editor_action(this.id)',  'insert_table.gif'],
    "htmlmode":       ['HtmlMode',             'Ver Codigo Fuente',  'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
