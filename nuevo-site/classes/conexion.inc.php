<?PHP
//$link = mysql_connect("localhost", "andamioa_admin", "Ingr3so01");
//mysql_select_db("andamioa_store", $link);
...
function DB_mysql($bd = "andamios_alfa", $host = "localhost", $user = "root", $pass = "") {
	$this->BaseDatos = $bd;
	$this->Servidor = $host;
	$this->Usuario = $user;
	$this->clave = $pass;
